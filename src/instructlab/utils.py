...
def validate_taxonomy(
    ...
    # the estimated length of a sample generated through sdg is 1500 tokens
    total_estimated_sdg_tokens = (
        cumulative_estimated_sdg_samples * estimated_tokens_per_sdg_sample
    )
    logger.info(
        "total estimated sdg samples for taxonomy: %d", cumulative_estimated_sdg_samples
    )
    logger.info(
